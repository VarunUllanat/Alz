...
dataframes = get_dataframes(gse_filt, "Frontal_Cortex")
...
cemi_results_all = run_CEMitool(all_exprs_dfs, pheno_df, c(20,NA,10), c(TRUE,FALSE,TRUE))
cemi_results_dge = run_CEMitool(new_exprs_dfs, pheno_df, c(20,5,5), c(TRUE,TRUE,TRUE))
