...
dataframes = get_dataframes(gse_filt, "Entorhinal_Cortex")
...
cemi_results_all = run_CEMitool(all_exprs_dfs, pheno_df, c(NA,20,9), c(FALSE,TRUE,TRUE))
cemi_results_dge = run_CEMitool(new_exprs_dfs, pheno_df, c(NA,20, 10), c(FALSE,TRUE,TRUE))
