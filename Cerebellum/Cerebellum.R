...
dataframes = get_dataframes(gse_filt, "Cerebellum")
...
cemi_results_all = run_CEMitool(all_exprs_dfs, pheno_df, c(NA,20,9), c(FALSE,FALSE,FALSE))
cemi_results_dge = run_CEMitool(new_exprs_dfs, pheno_df, c(NA,20, 10), c(FALSE,FALSE,FALSE))
...
add_interactions(cemi_results_all[[2]],int_df)
